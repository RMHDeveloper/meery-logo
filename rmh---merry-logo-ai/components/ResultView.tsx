  ...
  return (
    <div className="space-y-6 animate-in fade-in zoom-in duration-500">
      ...
      <details className="bg-gray-50 rounded-xl border border-gray-100 p-4">
        <summary className="text-sm font-medium text-gray-600 cursor-pointer select-none">Design brief</summary>
        <p className="text-sm text-gray-500 mt-3 leading-relaxed text-justify [hyphens:auto]">{result.description}</p>
      </details>
