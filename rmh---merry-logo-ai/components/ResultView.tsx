...
const ResultView: React.FC<ResultViewProps> = ({ result, companyName, onRestart }) => {
  const fileName = `ornament_${result.timestamp}.jpg`;
  ...
  const handleWhatsAppShare = () => {
    const text = encodeURIComponent(`Check out our festive ornament for ${companyName}! Crafted with Merry Logo AI. 🎄✨`);
    ...
    <div className="space-y-6 animate-in fade-in zoom-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center space-x-2 bg-[#25D366] hover:bg-[#128C7E] text-white py-3 px-6 rounded-lg transition-all shadow-lg active:scale-95"
        >
